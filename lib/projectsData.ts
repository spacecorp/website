...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "3D models and visual concepts for audio production equipment.",
    longDescription:
  ...
  // Games/Addons Category (World of Warcraft)
  {
    ...
    description:
      "World of Warcraft addon for character customization and expression.",
    longDescription:
  ...
  },
  {
    ...
    title: "Nurse Nancy",
    description:
      "World of Warcraft companion addon with utility and gameplay enhancements.",
    longDescription:
  ...
  },
  {
    ...
    title: "Divine Window",
    description:
      "World of Warcraft interface enhancement for divine and holy themes.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "World of Warcraft addon for automated messages and AFK management.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Carcassone expansion by Pennautier introducing mystical and deceptive elements.",
    longDescription:
  ...
  // Apps/Interactive/Web Category
  {
    ...
    description:
      "Web tool for managing and organizing presets for Chase Bliss Audio gear.",
    longDescription:
  ...
  },
  {
    ...
    title: "Gleamy",
    description:
      "Interactive web application for creative expression and visual exploration.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Print and graphic design project for cultural event branding and collateral.",
    longDescription:
